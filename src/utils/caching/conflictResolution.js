...
export class ConflictResolver {
  ...
  async resolveConflicts(localData, serverData, entityType, entityId) {
    try {
      console.log('Resolving conflicts for:', entityType, entityId);
      ...
      console.log('Conflict resolved:', conflictId, resolvedData);
      return resolvedData;
    } catch (error) {
  ...
  async resolveUserProfileConflict(localData, serverData) {
    console.log('Resolving user profile conflict...');
  ...
  async resolvePostConflict(localData, serverData) {
    console.log('Resolving post conflict...');
  ...
  async resolveSocialInteractionConflict(localData, serverData) {
    console.log('Resolving social interaction conflict...');
  ...
  async resolvePreferenceConflict(localData, serverData) {
    console.log('Resolving preference conflict...');
  ...
  async clearResolvedConflicts(olderThanDays = 7) {
    try {
      ...
      console.log('Cleared old resolved conflicts');
    } catch (error) {
