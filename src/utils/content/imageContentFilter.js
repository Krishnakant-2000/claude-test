...
export const analyzeImageMetadata = (file) => {
...
export const analyzeImageDimensions = (file) => {
...
export const analyzeImageColors = (file) => {
  return new Promise((resolve, reject) => {
...
export const analyzeImageContent = async (file) => {
  try {
    console.log('🔍 Analyzing image content:', file.name);
    ...
    console.log('📊 Image analysis complete:', combinedResult);
...
export const quickImageValidation = async (file) => {
