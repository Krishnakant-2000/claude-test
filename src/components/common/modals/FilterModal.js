...
const FilterModal = memo(({ currentFilters = {}, onApply, onClose }) => {
                ...
                <div className="filter-checkbox-group">
                  ...
                  <label className="checkbox-option">
                    <input 
                      ...
                      onChange={(e) => handleFilterChange('originalContent', e.target.checked)}
                    />
                ...
                <div className="filter-radio-group">
                  <label className="radio-option">
                    <input 
                      ...
                      onChange={(e) => handleFilterChange('followingStatus', e.target.value)}
                    />
                    <span>All Users</span>
                  </label>
                  <label className="radio-option">
